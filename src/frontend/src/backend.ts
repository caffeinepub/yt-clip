...
export class Backend implements backendInterface {
    ...
    async createClip(arg0: string, arg1: string, arg2: bigint, arg3: bigint): Promise<{
        id: bigint;
        timestamp: bigint;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.createClip(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteClip(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
